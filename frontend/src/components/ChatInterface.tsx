    ...
    return (
        <Flex h="calc(100vh - 60px)" position="relative" bg={bgColor} flexDirection="row">
            ...
            >
                ...
                <Box
                    width="100%"
                    maxWidth="800px" // Match input area width
                    mx="auto" // Center it
                    px={{ base: 2, md: 4 }}
                ...
                >
                    <Text fontSize="xs" color={useColorModeValue("gray.500", "gray.400")}>
                        <strong>Disclaimer:</strong> The responses provided by Katalyst Assistant are generated by an AI model (Google Gemini) and are intended for informational purposes only. While the assistant aims to be helpful, the information may contain inaccuracies or omissions. It should not be considered a substitute for professional advice or official documentation regarding IFS ERP or any other system. Always verify critical information with trusted sources or experts.
                    </Text>
                </Box>
            </Flex>
        </Flex>
